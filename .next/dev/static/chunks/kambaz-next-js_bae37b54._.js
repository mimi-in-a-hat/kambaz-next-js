...
const deleteModule = async (moduleId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${MODULES_API}/${moduleId}`);
    return response.data;
};
const updateModule = async (module)=>{
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${MODULES_API}/${module._id}`, module);
    return data;
};
...
"[project]/kambaz-next-js/app/(kambaz)/enrollments/client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/kambaz-next-js/app/(kambaz)/dashboard/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/kambaz-next-js/app/(kambaz)/enrollments/client.ts [app-client] (ecmascript)");
...
function Dashboard() {
    ...
    const { enrollments } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "Dashboard.useSelector": (state)=>state.enrollmentsReducer
    }["Dashboard.useSelector"]);
    const [showAllCourses, setShowAllCourses] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const onAddCourse = async ()=>{
        ...
        const newCourse = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCourse"]({
        ...
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCourses"])([
            ...courses,
            newCourse
        ]));
    ...
    const onDeleteCourse = async (courseId)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCourse"](courseId);
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCourse"])(courseId));
    };
        ...
        "Dashboard.useEffect": ()=>{
            const loadData = {
                "Dashboard.useEffect.loadData": async ()=>{
                    try {
                        const fetchedCourses = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAllCourses"]();
                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCourses"])(fetchedCourses));
                    } catch (error) {
                        console.error(error);
                    }
                    try {
                        const fetchedEnrollments = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findMyEnrollments"]();
                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setEnrollments"])(fetchedEnrollments));
                    } catch (error) {
                        console.error(error);
                    }
                }
    ...
    const onUpdateCourse = async (course)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCourse"](course);
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$courses$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCourse"])(course));
    };
    ...
    const handleEnroll = async (courseId)=>{
        if (currentUser) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enrollUserInCourse"](courseId);
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enrollUser"])({
    ...
    const handleUnenroll = async (courseId)=>{
        if (currentUser) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unenrollUserFromCourse"](courseId);
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$enrollments$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unenrollUser"])({
                userId: currentUser._id,
                courseId
            }));
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        id: "wd-dashboard",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
...
_s(Dashboard, "E8lYAoWUr27EGU4vFeVh3jO2nro=", false, function() {
    return [
...
//# sourceMappingURL=kambaz-next-js_bae37b54._.js.map