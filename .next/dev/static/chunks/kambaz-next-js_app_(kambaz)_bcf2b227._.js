...
const signup = async (credentials)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${USERS_API}/signup`, credentials);
...
"[project]/kambaz-next-js/app/(kambaz)/account/signup/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Signup() {
    _s();
    const [credentials, setCredentials] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const signup = async ()=>{
        ...
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signup"]({
                username,
                password
            });
            if (!user) {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$app$2f28$kambaz$292f$account$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCurrentUser"])(user));
            router.push("/account/profile");
        } catch (e) {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$kambaz$2d$next$2d$js$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].isAxiosError(e)) {
...
_s(Signup, "fwI/it/dkX43+d+z1ev6MjZNHGE=", false, function() {
    return [
...
//# sourceMappingURL=kambaz-next-js_app_%28kambaz%29_bcf2b227._.js.map